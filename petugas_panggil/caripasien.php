    ...
    <div>
        <div class="sidebar">
            <ul style="margin-top: 170%;">
                <li><a href="daspanggil.php">KEMBALI</a></li>
            </ul>
        </div>
            ...
            <table>
                <tr>
                    ...
                    <form action="caripasien.php" method="POST">
                        <td width="200px"><input type="text" placeholder="Input Nama Pasien" name="cari" size="30"></td>
        ...
        <div style="margin-left: 16%; margin-right: 1%;">
            ...
            <?php
                if (isset($_POST['cari'])) {
                    ...
                    $hasil = mysqli_query($conn,"select * from data_pas where nama like '%$cari%'"); 
